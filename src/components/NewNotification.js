...
const NewNotification = () => {
  ...
  const loadUser = () => {
    UserService.getOneByEmail(AuthService.getUserEmail())
      .then((res) => {
  ...
  const postNotification = async () => {
    ...
    const response = await NotificationService.save(data);
        ...
        <div className="col-12 my-2">
          <div className="form-group mb-1">
            ...
            {notificationType === "SYSTEM" ? (
              ...
              <span className="form-text tex-info">
                Notification will be send to users with role: {notificationType}
              </span>
            )}
          </div>
          <div className="form-group mb-1">
          ...
          <button className="btn btn-primary my-1" onClick={postNotification}>
            Post Notification
          </button>
        </div>
      </div>
