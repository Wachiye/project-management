        ...
        <div className="card-text pull-right">
          <div className="btn-group">
            ...
            {canApprove && file.status === "PENDING" && (
              <>
                <button
                  ...
                  title="Approve"
                  onClick={() => approveFileFun(file._id, "ACCEPTED")}
                >
                  Approve
                </button>
                <button
                  ...
                  title="Reject"
                  onClick={() => approveFileFun(file._id, "REJECTED")}
                >
                  Reject
                </button>
              </>
            ...
            <Link
              ...
              to={`/projects/${file?.project?._id}/files/${file._id}`}
            >
              View
            </Link>
            {canDelete && (
              <button
                ...
                title="Delete"
                onClick={() => deleteFileFun(file._id)}
              >
                Delete
              </button>
            )}
