      ...
      <ul className="list-inline">
        <li className="list-inline-item">
          ...
          <ModalContainer
            ...
            setActive={setShow}
            size={"md"}
            title={`Contact ${user?.fullName || user?.user?.fullName}  `}
            id={user._id}
          >
            <ContactForm
              user={user}
          ...
          <>
            <li className="list-inline-item">
              ...
              >
                <EditUser
                  user={user}
                  stdRegNo={user?.regNo || null}
                  staffNo={user?.staffId || null}
                />
              </ModalContainer>
            </li>
            <li className="list-inline-item">
              <button
                ...
                type="button"
                onClick={() => deleteFn(user?._id, userRole)}
              >
    ...
    <table className="table table-bordered">
      <thead className="bg-dark text-light">
        <tr>
          ...
          <th>Email</th>
          <th>Role</th>
          {userRole === "STUDENT" && <th>RegNo</th>}
          {userRole === "STAFF" && <th>Staff ID</th>}
          <th>Date Joined</th>
          <th>Action</th>
        </tr>
      </thead>
