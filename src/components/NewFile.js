...
class NewFile extends Component {
  ...
  async uploadFile() {
    isLoading(true);
    const { name, description, file, type, project } = this.state;
  ...
  async componentDidMount() {
    isLoading(true);
    const _id = this.props.projectId || this.props.match.params.projectId;
    this.setState({
      projectId: _id
    });
  ...
  render() {
    const { hasAlert, alert, project } = this.state;
    return (
                      ...
                      <div className="col-12 m-auto mb-2">
                        ...
                        <div className="form-group">
                          ...
                          <span className="form-text">
                            Eg. Project Proposal for {project?.name || "xzy"} Project
                          </span>
                        </div>
