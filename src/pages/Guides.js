...
class Guides extends Component {
  ...
  canDelete() {
    ...
    if (["EVALUATOR", "ADMINISTRATOR"].includes(role)) return true;
    else return false;
  }
  ...
  render() {
    const { guides, alert, hasAlert } = this.state;
    return (
          ...
          <div className="row">
            <div className="col-12 mb-2">
              <div className="d-flex justify-content-between align-items-center">
                ...
                <div>
                  {this.canDelete() && (
                    <Link to="/new-guide" className="btn btn-sm btn-primary">
                      New Guide
                    </Link>
                  )}
                </div>
