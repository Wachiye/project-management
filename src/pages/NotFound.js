            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-text">
                  Ensure that the URL is correct and try again. <br />
                  If the problem persists or you think the URL is correct, please contact the
                  developer.
                </p>
                <p>
              ...
              <div className="card-footer bg-transparent">
                ...
                <p className="card-text">
                  <a
                    href={`mailto:${developer.email}?Subject=PAGE%20NOT%20FOUND&Message=${body}&Body=${body}`}
                  >
...
const NotFound = () => {
  ...
  return <NotFoundContainer role={role} token={token} body={body} developer={developer} />;
};
